...
if(isset($_POST['btn']))
{
$max_qry = mysql_query("select max(id) from bus");
	$max_row = mysql_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;
$qry=mysql_query("insert into bus(id,name,bno,spoint,epoint,stp,time)values('$id','$name','$bno','$spoint','$epoint','$stop','$time')");
if($qry)
{
...
<form id="form1" method="post" action="">
		  ...
		  <h1 align="center">Add New  Bus Details </h1> 
